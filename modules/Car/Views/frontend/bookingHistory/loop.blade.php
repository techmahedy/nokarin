<tr>
    ...
    <td width="2%">
        ...
        @if ($booking->object_model === 'car')
            <button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#exampleModal" data-backdrop="static" data-keyboard="false" style="margin-top:5px;">
                {{__("Assign Driver")}}
            </button>
            @include(ucfirst($booking->object_model).'::frontend.bookingHistory.modal')
        @endif
