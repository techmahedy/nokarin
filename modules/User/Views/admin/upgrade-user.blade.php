                        ...
                        @if($rows->total() > 0)
                            @foreach($rows as $row)
                                <tr>
                                    ...
                                    <td class="title">
                                        @if (@$row->user->vendor_type === 'hotel')
                                            {{ __('Hotel') }}
                                        @elseif(@$row->user->vendor_type === 'tours')
                                            {{ __('Tours') }}
                                        @elseif(@$row->user->vendor_type === 'staycation_rental')
                                            {{ __('Staycation Rental') }}
                                        @elseif(@$row->user->vendor_type === 'car_rental')
                                            {{ __('Car Rental') }}
                                        @elseif(@$row->user->vendor_type === 'events')
                                            {{ __('Events') }}
                                        @endif
                                    </td>
